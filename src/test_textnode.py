...
class TestTextNode(unittest.TestCase):
    ...
    def test_not_eq(self):
        ...
        node5 =  TextNode("This is a text node", TextType.ITALIC, "pipiska.com")
        node6 = TextNode("This is a text node", TextType.ITALIC, "pipka.com")
        self.assertNotEqual(node5, node6)

    def test_convert_to_repr(self):
        node = TextNode("This is a text node", TextType.BOLD)
